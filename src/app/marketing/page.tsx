        ...
        <table className="w-full text-left text-sm">
          <thead className="bg-indigo-50/60 text-xs font-semibold tracking-wide text-zinc-500 uppercase dark:bg-indigo-950/30 dark:text-zinc-400">
            <tr>
              ...
              <th className="px-4 py-2.5 text-center text-[10px]">Nama Motif</th>
              <th className="px-4 py-2.5 text-center text-[10px]">Filosofi Motif</th>
              <th className="px-4 py-2.5 text-center text-[10px]">SKU</th>
              <th className="px-4 py-2.5 text-center text-[10px]">Kategori / USP</th>
              <th className="px-4 py-2.5 text-center text-[10px]">Tanggal Ready Stok</th>
              <th className="px-4 py-2.5 text-center text-[10px]">Tanggal Ready to Launch</th>
              ...
              <th className="px-4 py-2.5 text-center text-[10px]">Status Marketing</th>
              <th className="px-4 py-2.5 text-center text-[10px]"></th>
            </tr>
          </thead>
          <tbody>
